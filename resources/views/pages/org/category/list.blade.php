              ...
              <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-height fixed-columns">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-sm font-weight-normal">{{$c->type}}</td>
                    <td class="text-sm font-weight-normal"> <a href="{{route('show_category_info', ['id' => $c->id])}}" class="btn btn-primary">Open</a></td>
                  </tr>
                  @endforeach
                  @else
                  <tr>
                    <td class="text-sm font-weight-normal" colspan="3" style="text-align: center;">NO categories yet. want to create? <a href="{{route('show_add_category')}}">Click here</a> </td>
                  </tr>
                  @endif
                  </tbody>
              </table>
