          ...
          <div class="card-body p-3 position-relative">
            ...
            <div class="col text-start">
                <div class="dropdown text-end">
                    ...
                    |
                    <a href="#" class="cursor-pointer text-secondary">
                      <span class="text-xs text-secondary"> Location</span>
                    </a>
                    |
                    <a href="#" class="cursor-pointer text-secondary">
        ...
        <div class="multisteps-form">
            ...
            <div class="row">
              <div class="col-12 col-lg-8 m-auto">
                <form class="multisteps-form__form mb-8" style="height: 406px;" action="{{route('store_location')}}" method="post">
                  @csrf
                  <!--single form panel-->
                    ...
                    <div class="multisteps-form__content">
                      <div class="row mt-3">
                        <div class="col-12 col-sm-12">
                          <label>Name</label>
                          <select class="multisteps-form__select form-control" name="name">
                          <option disabled selected>Select State</option>
                          @foreach ($locations as $l)
                              <option value="{{$l->id}}" @selected(old('name') == $l)>
                                {{$l->name}}
                              </option>
                          @endforeach
                          </select>
