        ...
        <div class="card border-radius-xs">
          <div class="card-body p-3 position-relative">
            ...
            <div class="col text-start">
                ...
                <p> List of devices</p>
                <div>
                    <a href="{{route('show_add_device')}}" class="btn btn-default border-radius-xs">add</a>
              ...
              <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-height fixed-columns">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-sm font-weight-normal">{{$d->station->name}}</td>
                    <td class="text-sm font-weight-normal"> <a href="{{route('show_device_info', ['id' => $d->id])}}" class="btn btn-primary">Open</a></td>
                  </tr>
                  @endforeach
                  @else
                  <tr>
                    <td class="text-sm font-weight-normal" colspan="3" style="text-align: center;">NO devices yet. create clusters? <a href="{{route('show_add_device')}}">Click here</a></td>
                  </tr>
                  @endif
                  </tbody>
              </table>
