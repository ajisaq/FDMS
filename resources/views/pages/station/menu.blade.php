    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0  my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav ms-4">
                        ...
                        <a class="nav-link" href="#">
                            ...
                            <span class="sidenav-normal"> Tanks </span>
                        </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="#">
                                <span class="sidenav-mini-icon"> P </span>
                                <span class="sidenav-normal"> Pumps </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="#">
                            <span class="sidenav-mini-icon"> D </span>
                            <span class="sidenav-normal"> Devices </span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#inventory" class="nav-link " aria-controls="inventory" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                        <i class="ni ni-collection text-primary text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1"><b>Inventory</b></span>
                    </a>
                ...
                <li class="nav-item ">
                    <a class="nav-link " href="#">
                        ...
                        <span class="nav-link-text ms-1"><b>Users</b></span>
                    </a>
                </li>
                <li class="nav-item">
